...
| 9. Auto Features & Leaderboard | 9/10 | In progress | 2026-05-30 (P09-09 FE Leaderboard panel + shared maskPlayerId — TanStack Query + WS leaderboard:updated inline cache replace + rank-up 200ms transition + own-row detection via shared SHA-256 prefix + tabbed right rail Live Feed | Leaderboard preserving Phase 7 D-01 grid byte-stable) |
